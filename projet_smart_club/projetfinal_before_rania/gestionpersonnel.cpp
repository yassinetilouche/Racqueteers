    ...
    ui(new Ui::gestionpersonnel)
{
    ...
    ui->player1_score_arduino->hide();
    ui->player1_score_label->hide();
    ui->player2_score_aduino->hide();
    ui->player2_score_label->hide();
    ui->game_over->hide();
    ...
    QCompleter *completerEmp = new QCompleter();
       ...
       QCompleter *completerMatch = new QCompleter();
       completerMatch->setModel(M.recherche_player_complete());
       ui->player_name_1_edit->setCompleter(completerMatch);
       QCompleter *completerMatch2 = new QCompleter();
       completerMatch2->setModel(M.recherche_player_complete());
       ui->player_name_2_edit->setCompleter(completerMatch2);
  //chart
...
void gestionpersonnel::update_label()
{
...
{       player1++;
        ...
        qDebug()<<player1;
        ui->player1_score_arduino->setText(player1_string);
    }
    else if (data=="2")
    {
        {       player2++;
                ...
                ui->player2_score_aduino->setText(player2_string);
            }
    }
...
void gestionpersonnel::on_game_over_clicked()
{
    match_id++;
    QString first_player_name=ui->player_name_1_edit->text();
    int first_player_score=ui->player1_score_arduino->text().toInt();
    QString second_player_name=ui->player_name_2_edit->text();
    int second_player_score=ui->player2_score_aduino->text().toInt();
...
void gestionpersonnel::on_start_game_clicked()
{

    ui->player1_score_arduino->show();
    ui->player1_score_label->show();
    ui->player2_score_aduino->show();
    ui->player2_score_label->show();
    ui->game_over->show();
    ui->start_game->hide();
}
